...
extern void draw_str(short x, short y, uchar *str, unsigned int maxlen);
extern void draw_fixed_width_str(short x, short y, uchar *str, short width);
extern void draw_str_in_box(struct st_box *box, unsigned char hattr, unsigned char vattr, uchar *str);
