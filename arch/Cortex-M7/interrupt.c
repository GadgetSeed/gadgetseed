...
int is_in_interrupt(void)
{
	...
	asm("mrs %[result], ipsr" : [result] "=r" (regIPSR) : : );
...
void ur_inthdr_104(unsigned int intnum, void *sp){unreg_inthdr(104,sp);}
void ur_inthdr_105(unsigned int intnum, void *sp){unreg_inthdr(105,sp);}
void ur_inthdr_106(unsigned int intnum, void *sp){unreg_inthdr(106,sp);}
void ur_inthdr_107(unsigned int intnum, void *sp){unreg_inthdr(107,sp);}
void ur_inthdr_108(unsigned int intnum, void *sp){unreg_inthdr(108,sp);}
void ur_inthdr_109(unsigned int intnum, void *sp){unreg_inthdr(109,sp);}
void ur_inthdr_110(unsigned int intnum, void *sp){unreg_inthdr(110,sp);}
void ur_inthdr_111(unsigned int intnum, void *sp){unreg_inthdr(111,sp);}
void ur_inthdr_112(unsigned int intnum, void *sp){unreg_inthdr(112,sp);}
void ur_inthdr_113(unsigned int intnum, void *sp){unreg_inthdr(113,sp);}
void ur_inthdr_114(unsigned int intnum, void *sp){unreg_inthdr(114,sp);}
void ur_inthdr_115(unsigned int intnum, void *sp){unreg_inthdr(115,sp);}
void ur_inthdr_116(unsigned int intnum, void *sp){unreg_inthdr(116,sp);}
void ur_inthdr_117(unsigned int intnum, void *sp){unreg_inthdr(117,sp);}
void ur_inthdr_118(unsigned int intnum, void *sp){unreg_inthdr(118,sp);}
void ur_inthdr_119(unsigned int intnum, void *sp){unreg_inthdr(119,sp);}
void ur_inthdr_120(unsigned int intnum, void *sp){unreg_inthdr(120,sp);}
void ur_inthdr_121(unsigned int intnum, void *sp){unreg_inthdr(121,sp);}
void ur_inthdr_122(unsigned int intnum, void *sp){unreg_inthdr(122,sp);}
void ur_inthdr_123(unsigned int intnum, void *sp){unreg_inthdr(123,sp);}
void ur_inthdr_124(unsigned int intnum, void *sp){unreg_inthdr(124,sp);}
void ur_inthdr_125(unsigned int intnum, void *sp){unreg_inthdr(125,sp);}
...
#ifdef GSC_KERNEL_ENABLE_INTERRUPT_COUNT	// $gsc カーネル割込カウンタを有効にする
