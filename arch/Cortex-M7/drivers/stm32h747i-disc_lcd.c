/** @file
    @brief	STM32H747I Discovery LCD ドライバ
...
//	BSP_LCD_Init(0, LCD_ORIENTATION_LANDSCAPE);
	...
	BSP_LCD_SetLayerAddress(0, 0, (uint32_t)lcd_f_buffer_main);
...
static int lcd_ioctl(struct st_device *dev, unsigned int com, unsigned int arg, void *param)
{
	...
	case IOCMD_VIDEO_SETDISPFRAME:
		...
		case 1:
			BSP_LCD_SetLayerAddress(0, 0, (uint32_t)lcd_f_buffer_sub);
			break;
...
const struct st_device lcd_device = {
	...
	.explan		= "STM32H747I-Discovery LCD",
	.info		= (void *)&lcd_info,
